describe("Utilities test (with setup and tear-down)", function() {
    ...
    it('should sum tip be able to handle very large numbers and 2 decimal places on CalculateTipPercent()', function () {
        expect(calculateTipPercent(40000.44, 4000.44)).toEqual(10);
        expect(calculateTipPercent(40000, 4000)).toEqual(10);
